...
const PlaygameClient = ({games}:any) => {
...
//   }, [games]);
  ...
  useEffect(() => {
    ...
    if (searchParams.get('paymenySynced')) {
      ...
      playChallenge({
        ...
        isDesktopDevice:searchParams.get('isDesktopDevice'),
        isMobileDevice:searchParams.get('isMobileDevice'),
  ...
  return (
    <div>
      <GameScreen data={games} scoreToBeat={scoreToBeat} />
    </div>
  );
};
